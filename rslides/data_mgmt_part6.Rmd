...
names_to: You will provide a name for the new categorical variable to store your old variable names. So when you pivot longer your variable names will become a new categorical column. You can name this column whatever you want. This name needs to be in quotation marks when you add it to your argument.

values_to: You will provide a name for the new variable storing your values. When you pivot longer your values will be combined into this one column. Again, you can name this column whatever you want. This name needs to be in quotation marks when you add it to your argument.
