...
There may be other ways to link IDs preemptively, like getting class rosters and adding all students to your participant tracking database and assigning IDs

But if there are no other options, my only recommendation is that as soon as those forms come back to you with names, you check if those participants already exist in your participant database (so you don't assign them yet another ID). If they do, you connect these forms to their existing ID. If they don't already exist, you assign those participants new IDs.
...
Or did we follow best practices and restrict all of our data entry fields to only our allowable values
