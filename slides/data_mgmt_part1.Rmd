...
Slides available on [`r fontawesome::fa("github", fill = "white")`](https://cghlewis.github.io/mpsi-training1/#1)

---

# About me

* Data Manager for Missouri Prevention Science Institute for 8 years. Oversaw data management for 8 large-scale federally funded grants and 1 county funded grant.
...
4\. Keeps data secure
  - Data security is required by both theIRB and funders
...
- <span style = 'font-size: 150%;'>`r fontawesome::fa("exclamation-triangle", fill = "#782F40")`</span>  It is best practice to do these steps **EVERY** cycle.
...
2. **Project Coordinator**
  - Creation of protocols and project documentation
  - Hiring contract staff
  - Training data collectors
  - Creating data collection instruments
  - Scheduling and oversight of data collection
...
3\. **Data Manager**
  - Data documentation
  - Oversee security of data (storage, access, permissions, privacy)
  - Data capture (downloading, entry)
  - Data cleaning
  - Data validation
  - Data sharing

4\. **Other roles**
  - Database developer (Develop Qualtrics surveys, develop tracking databases, develop data entry databases)
  - Graduate research assistants (Data collection, project coordination, data cleaning, data analysis)
  - Methodologist (Randomization, study design, data analysis)
  - IT professionals (Data storage, data backup, data security)
  - Contractors (Data collection, data entry, transcribing)
  - Researchers/post-docs (data analysis, data collection, documentation)
...
The best way to assign responsibilities may be by developing a flow chart for each project/measure
...
# Why is Documentation Step #1?

**It is a roadmap for where you are going.**

```{r, echo = FALSE, out.width = "725px", fig.align='center'}
knitr::include_graphics("img/documentation.png")
```
...
A lab manual is important because it creates common knowledge.
...
|Who creates it|When to create | Formats|
|-------------|---------------|--------|
|PI, Project Coordinators |When lab is formed|Markdown, PDF, Word|
...
A style guide is a document that provides a set of standards for how you work with your data.
...
|Who creates it|When to create | Formats|
|-------------|---------------|--------|
|PI, Project Coordinators, Data Managers |Before a project begins, When a lab is formed|Markdown, PDF, Word, txt|
...
### **Harvard Strategic Data Project has an excellent style guide for reference**
